...
func printHelp() {
	...
	fmt.Println("     go run main.go -web -addr 127.0.0.1:8080")
}
...
func main() {
	...
	domainGen, err := generator.GenerateDomains(*length, *suffix, *pattern, *regexFilter, *dictFile)
	if err != nil {
		fmt.Printf("Error generating domains: %v\n", err)
		os.Exit(1)
	}
